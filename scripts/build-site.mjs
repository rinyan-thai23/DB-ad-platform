...
function tags(r) {
  ...
  return `<div class="tags"><span class="tag ${r.japan_bank_only_complete==='Yes'?'good':'warn'}">日本の銀行のみ: ${bankLabel}</span><span class="tag">初心者適性: ${esc(r.beginner_tier)}</span><span class="tag">広告の強さ: ${esc(r.UX_intrusiveness_1_5)}/5</span></div>`;
}
