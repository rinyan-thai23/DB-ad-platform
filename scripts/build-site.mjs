...
function homePage() {
  const featuredSlugs = ['beginner','no-custom-domain','japan-bank','paypal','international-wire','low-payout','native-ads','growth'];
  ...
  const body = `<section class="hero"><div class="wrap hero-grid"><div><p class="eyebrow">日本語サイト向け広告データベース・2026年版</p><h1>広告を、単価ではなく<br><em>始めやすさ</em>で選ぶ。</h1><p class="lead">日本語サイト、独自ドメイン、日本の銀行口座。あなたの今の条件から、使える広告プラットフォームを絞り込みます。</p></div><aside class="hero-panel"><div class="big-number">30</div><div class="metric-label">広告サービスを同一基準で比較</div><p class="metric-sub">50以上の調査項目／公式情報と推定を分離／毎月更新を想定</p></aside></div></section>
