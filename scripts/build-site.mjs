...
function homePage() {
  ...
  <section class="section"><div class="wrap"><a class="article-callout" href="${href('/articles/cloudflare-pages-monetization/')}"><div><p class="eyebrow">おすすめの収益化方法</p><h2>Cloudflare Pagesの無料URLから収益化を始める方法</h2><p>複数のツールを1サイトにまとめ、無料公開の段階と独自ドメイン取得後で広告サービスをどう選ぶかを整理しました。</p></div><strong>公開ガイドを読む →</strong></a></div></section>
